            ...
            //クリックイベント
                    .click(function(e) {
                        ...
                        if(!$(e.target).is('a')){
                            ...
                            parent.window.location = $(e.target).closest('tr').data('href');}
                    });
        });
    </script>
    <!-- start-smoth-scrolling -->
...
function printTable($list){
    foreach($list as $item){
        ...
        echo '<tr data-href="/single/?goodsid='.$item->id.'" id="link" class="clickable"><td id="pname">'.$item->name.'</td><td>'.$item->genres_id.'</td><td><img src="'.$item->image.'" class="contain"></td><td hidden>'.$item->id.'</td></a></tr>' . PHP_EOL;
